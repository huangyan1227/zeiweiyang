...
/** 结束刷新后的回调 */
typedef void (^MJRefreshComponentEndRefreshingCompletionBlovoidck)(void);
...
/** 结束刷新的回调 */
@property (copy, nonatomic) MJRefreshComponentEndRefreshingCompletionBlovoidck endRefreshingCompletionBlock;
/** 结束刷新状态 */
- (void)endRefreshing;
