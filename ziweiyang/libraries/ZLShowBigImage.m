...
+ (void)hideImage:(UITapGestureRecognizer*)tap{
    ...
    UIImageView *imageView = (UIImageView*)[tap.view viewWithTag:109];
    [UIView animateWithDuration:0.3 animations:^{
