//
//  EntiytTableViewCell.m
//  ziweiyang
//
//  Created by bidiao on 2017/12/6.
//  Copyright © 2017年 bidiao. All rights reserved.
//

#import "EntiytTableViewCell.h"

@implementation EntiytTableViewCell
{
    UILabel * _nameLabel1;
    UILabel * _nameLabel2;
    UILabel * _nameLabel3;
...
-(void)setArightmodel:(RightModel *)arightmodel
{
    
    _arightmodel = arightmodel;
    
    [self titlelable:_nameLabel1 titletitle:arightmodel.namelabel1];
    [self titlelable:_nameLabel2 titletitle:arightmodel.namelabel2];
    [self titlelable:_nameLabel3 titletitle:arightmodel.namelabel3];
    [self titlelable:_nameLabel4 titletitle:arightmodel.namelabel4];
    [self titlelable:_nameLabel5 titletitle:arightmodel.namelabel5];
        ...
        //需要转换的字符串
        NSString *dateString = arightmodel.entitycreate_date;
        // 设置转换格式
        ...
        _nameLabeltext2.text = arightmodel.entityproduct_code;
        _nameLabeltext3.text = arightmodel.entityproduct_name;
        _nameLabeltext4.text = arightmodel.entityqty;
        _nameLabeltext5.text = arightmodel.entitycoin;
//
   ...
   // _nameLabeltext5.text = arightmodel.namelabeltext5;
